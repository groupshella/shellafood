...
export function PriceTag({ amount, size = "lg", className }: PriceTagProps) {
    ...
    return (
        <span className={[isLarge ? "text-[22px] font-bold leading-none tracking-tight text-gray-900" : "text-[13px] text-gray-400", className].filter(Boolean).join(" ")}>
            {formatPrice(amount)}
