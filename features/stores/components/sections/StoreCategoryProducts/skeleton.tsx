...
function ListCardSkeleton() {
	return (
		<div className="flex w-full min-w-0 items-center gap-3 rounded-2xl bg-white p-3 shadow-[0_1px_3px_rgba(0,0,0,0.04)] ring-1 ring-black/[0.05] dark:bg-gray-800 dark:ring-white/[0.06] sm:gap-3.5 sm:p-3.5">
			<div className="h-[4.5rem] w-[4.5rem] shrink-0 animate-pulse rounded-2xl bg-gray-100 dark:bg-gray-700 sm:h-20 sm:w-20" />
			...
			<div className="h-10 w-10 shrink-0 animate-pulse rounded-full bg-gray-100 dark:bg-gray-700 sm:h-11 sm:w-11" />
		</div>
	);
}
...
function GridCardSkeleton() {
	return (
		<div className="flex w-full min-w-0 flex-col overflow-hidden rounded-xl bg-white shadow-[0_2px_10px_rgba(0,0,0,0.05)] ring-1 ring-black/[0.03] dark:bg-gray-800 dark:ring-white/[0.05]">
...
export default function StoreCategoryProductsSkeleton() {
	return (
		<div className="animate-pulse px-3 pb-4 pt-2.5 sm:px-4 sm:pb-5 sm:pt-3 md:px-5 lg:mx-auto lg:max-w-4xl lg:px-6 xl:max-w-5xl 2xl:max-w-6xl">
			<div className="mb-2.5 h-5 w-28 rounded bg-gray-200 ms-auto dark:bg-gray-700 sm:mb-3 sm:h-6 sm:w-32 md:mb-3.5" />
