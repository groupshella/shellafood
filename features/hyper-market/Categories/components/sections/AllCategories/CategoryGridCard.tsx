...
export function CategoryGridCard({ category }: CategoryGridCardProps) {
    ...
    return (
        <Link
            ...
            className={[
                "relative flex aspect-[4/5] w-full flex-col overflow-hidden rounded-2xl bg-[#E8F9EE]",
        ...
        >
            <svg
                className="pointer-events-none absolute -bottom-6 left-1/2 h-[70%] w-[120%] -translate-x-1/2 text-[#C8EDD4]"
                viewBox="0 0 200 120"
                fill="currentColor"
                aria-hidden
            >
            ...
            <h3 className="relative z-10 line-clamp-2 px-2 pt-2.5 text-center text-[11px] font-bold leading-tight text-[#1F6B3A] sm:text-xs">
                {category.name}
            </h3>
