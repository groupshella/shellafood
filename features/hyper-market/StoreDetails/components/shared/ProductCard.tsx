    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 flex-col gap-0.5 p-2">
                <p className="line-clamp-2 text-[11px] font-semibold leading-tight text-[#111B18] sm:text-xs">{name}</p>
                <div className="mt-auto flex items-center gap-1.5">
                    <span className="text-xs font-bold text-[#111B18]">{price.toFixed(2)}</span>
                    {hasDiscount && (
