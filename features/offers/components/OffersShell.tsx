            ...
            <header className="sticky top-0 z-20 border-b border-black/[0.04] bg-white/95 backdrop-blur-md dark:border-white/[0.06] dark:bg-gray-900/95">
                <div className="relative flex min-h-[3.25rem] items-center justify-center px-3 py-2.5 sm:min-h-14 sm:px-4 md:px-5 lg:px-6">
                    <button
                        ...
                        aria-label="رجوع"
                    >
                        <ChevronRight className="h-5 w-5 text-[#30913F] dark:text-[#4db860] sm:h-[22px] sm:w-[22px]" strokeWidth={2} />
                    </button>

                    <div className="flex max-w-[60%] flex-col items-center sm:max-w-[70%]">
                        <h1 className="text-base font-bold text-gray-900 dark:text-gray-50 sm:text-lg">عروض وخصومات</h1>
                        {offerName && (
                    ...
                    <Link
                        ...
                        aria-label="السلة"
                    >
                        <ShoppingBag className="h-5 w-5 text-gray-700 dark:text-gray-300 sm:h-[22px] sm:w-[22px]" strokeWidth={2} />
                    </Link>
                </div>
            </header>
