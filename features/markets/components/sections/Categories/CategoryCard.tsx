...
const AVATAR_IDLE_HOVER = [
    ...
    "md:dark:group-hover:shadow-[0_4px_14px_rgba(0,0,0,0.28)]",
    "md:group-hover:ring-[#30913F]/15 dark:md:group-hover:ring-[#4db860]/20",
].join(" ");

const AVATAR_SELECTED = [
    "ring-2 ring-[#30913F]/80 ring-offset-2 ring-offset-white dark:ring-[#4db860]/75 dark:ring-offset-gray-900",
    "bg-[#F4FBF5] dark:bg-[#30913F]/12",
    "shadow-[0_2px_10px_rgba(48,145,63,0.16),0_4px_16px_rgba(0,0,0,0.05)]",
    "dark:shadow-[0_2px_10px_rgba(48,145,63,0.22),0_4px_16px_rgba(0,0,0,0.18)]",
].join(" ");

const PLACEHOLDER_CLASSES = [
    "flex h-full w-full items-center justify-center",
    "bg-gradient-to-br from-[#E8F5E9] to-white",
    "dark:from-[#30913F]/20 dark:to-gray-800",
...
export const CategoryCard = memo(function CategoryCard({
    ...
    const avatarClassName = [
        AVATAR_BASE,
        isSelected ? AVATAR_SELECTED : AVATAR_IDLE_HOVER,
    ].join(" ");
    ...
    const labelClassName = [
        ...
        isSelected
            ...
            : "font-medium text-gray-500 dark:text-gray-400 md:group-hover:text-gray-700 md:dark:group-hover:text-gray-300",
    ].join(" ");
