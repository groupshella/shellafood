    ...
    return (
        <Link
            ...
            className={[
                ...
                "bg-card",
                "shadow-[0_2px_8px_rgba(0,0,0,0.07)] ring-1 ring-border",
        ...
        >
            ...
            <div className="flex flex-1 flex-col gap-1 px-1.5 pb-2 pt-1.5 sm:px-2 sm:pb-2.5">
                <p className="line-clamp-2 min-h-[2.4em] text-start text-[11px] font-medium leading-snug text-foreground sm:text-xs lg:text-[13px]">
                    {product.name}
                </p>
                ...
                <div className="mt-auto flex flex-col gap-0.5">
                    <PriceTag
                        amount={displayPrice}
                        size="sm"
                        className="text-[11px] font-bold leading-none text-foreground sm:text-xs"
                    />
                    {discounted && (
                        <PriceTag
                            amount={product.price}
                            size="sm"
                            className="text-[10px] leading-none text-muted line-through sm:text-[11px]"
                        />
                    )}
                </div>
            </div>
