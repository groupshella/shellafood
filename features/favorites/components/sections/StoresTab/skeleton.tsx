        ...
        <div className={CONTENT_PADDING}>
            <div className={ITEMS_GRID}>
                {Array.from({ length: 3 }).map((_, i) => (
                    <div
                        key={i}
                        className="min-w-0 overflow-hidden rounded-2xl bg-background shadow-sm ring-1 ring-border lg:rounded-3xl"
                    >
                        <div className="h-32 w-full animate-pulse bg-card sm:h-36 md:h-40" />
                        <div className="flex items-center gap-2.5 px-3 py-3 sm:gap-3 sm:px-4 sm:py-3.5">
                            <div className="h-11 w-11 shrink-0 animate-pulse rounded-xl bg-card sm:h-12 sm:w-12" />
