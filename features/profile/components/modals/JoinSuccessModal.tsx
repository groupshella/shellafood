				...
				<>
					...
					<div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-6">
						<motion.div
							...
							className="relative max-h-[calc(100dvh-3rem)] w-full max-w-sm overflow-y-auto rounded-[32px] bg-background px-5 pb-10 pt-12 shadow-[0_20px_60px_rgba(0,0,0,0.12)] sm:max-w-md sm:px-6 md:max-w-lg"
						>
							<button
								type="button"
								onClick={onClose}
								className="absolute start-4 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-card text-muted transition-colors active:brightness-95"
							...
							<div className="flex flex-col items-center text-center">
								...
								<h2 className="text-lg font-bold leading-snug text-foreground sm:text-[18px]">
									{isArabic
										? "تم إرسال طلب انضمامك بنجاح"
										: "Your join request was sent successfully"}
								</h2>
