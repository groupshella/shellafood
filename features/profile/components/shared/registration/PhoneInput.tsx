...
function PhonePrefix() {
    return (
        <div className="flex shrink-0 items-center gap-2">
            <span className="text-[14px] font-normal text-[#111B18]">+966</span>
...
function PhoneDivider() {
    return <span className="mx-3 h-5 w-px shrink-0 bg-[#C6C8CE]" aria-hidden />;
}
    ...
    return (
        <div className={`${inputClassName} gap-0`} dir="ltr">
            ...
            <input
                ...
                className="min-w-0 flex-1 bg-transparent ps-3 text-start tabular-nums outline-none placeholder:text-[#707784]"
