...
export function ProfileRadioRow({ label, selected, href, onSelect }: ProfileRadioRowProps) {
    const className =
        "flex min-h-[52px] w-full items-center justify-between gap-4 border-b border-gray-100 px-1 py-4 transition-colors active:bg-gray-50 dark:border-gray-800 dark:active:bg-gray-800/60 last:border-b-0 sm:min-h-[56px] sm:px-2";
