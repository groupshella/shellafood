        ...
        >
            <div className="pointer-events-none absolute inset-0" aria-hidden>
                ...
                <Image
                    ...
                    width={40}
                    height={40}
                    className="absolute start-8 bottom-4 h-8 w-8 rotate-[12deg] object-contain opacity-75 sm:h-9 sm:w-9"
                />
                <Image
                    src="/profile/stat-coins.png"
                    alt=""
                    width={28}
                    height={28}
                    className="absolute end-10 bottom-6 h-6 w-6 rotate-[-8deg] object-contain opacity-70"
                />
            </div>
