...
export function QidhaPaymentMethodCard({
	...
	return (
		<button
			...
			className={[
				"flex h-[88px] w-[112px] shrink-0 flex-col items-center justify-center gap-2 rounded-[12px] border px-2 transition-colors sm:h-[96px] sm:w-[120px] md:h-[104px] md:w-[128px]",
				selected
		...
		>
			...
			<span
				className="text-center text-[11px] font-bold leading-tight text-foreground sm:text-[12px]"
				style={TAJAWAL}
			>
