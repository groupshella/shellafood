...
export function QidhaCard({
	...
	return (
		...
		>
				...
				<div className="relative z-10 flex flex-col gap-4 text-white">
					<div className="flex items-start justify-between gap-3">
						<span
							...
							style={TAJAWAL}
						>
							{card.statusLabel || (isArabic ? "متاح" : "Available")}
						</span>
					...
					<div className="flex flex-col items-end gap-1 text-end">
						...
						<div className="flex items-center gap-2 text-[12px] font-medium text-white/90 sm:text-[13px]">
							<span style={TAJAWAL}>
								{isArabic ? "تاريخ انتهاء الشهر" : "Month end date"}
							</span>
			...
			<div className="relative z-20 -mt-10 mx-3 rounded-[14px] bg-card px-3.5 py-3 shadow-[0px_4px_16px_rgba(0,0,0,0.08)] sm:mx-4 sm:px-4 sm:py-3.5">
				<div className="mb-2 flex items-center justify-between gap-2">
					<span
						className="text-[12px] font-medium text-muted sm:text-[13px]"
						style={TAJAWAL}
					>
				...
				<div className="mb-2 h-2 w-full overflow-hidden rounded-full bg-brand/15">
					<div
				...
				<div className="flex items-center justify-between gap-2">
					...
					<span
						className="text-[12px] font-bold text-brand sm:text-[13px]"
						style={TAJAWAL}
					>
