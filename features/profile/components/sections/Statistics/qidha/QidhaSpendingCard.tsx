...
export function QidhaSpendingCard({
    ...
    return (
        <div className="flex min-h-[100px] min-w-0 flex-col items-center justify-center gap-1.5 rounded-[12px] border border-[#F0EEF3] bg-white px-1.5 py-3 shadow-[0px_1px_8px_rgba(0,0,0,0.04)] dark:border-gray-700 dark:bg-gray-800 sm:px-2 sm:py-4">
            <div
            ...
            <span
                className="line-clamp-2 text-center text-[8px] font-medium leading-tight text-[#555555] dark:text-gray-400 sm:text-[9px]"
                style={TAJAWAL}
            >
                {label}
            </span>
