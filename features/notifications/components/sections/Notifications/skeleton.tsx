	...
	return (
		<div className={NOTIFICATIONS_GRID}>
			{Array.from({ length: 5 }).map((_, i) => (
				<div
					key={i}
					className="flex min-w-0 gap-2.5 rounded-2xl bg-card px-3 py-3 shadow-sm ring-1 ring-border sm:gap-3 sm:px-4 sm:py-3.5 lg:rounded-3xl"
				>
					<div className="h-11 w-11 shrink-0 animate-pulse rounded-xl bg-border sm:h-12 sm:w-12" />
