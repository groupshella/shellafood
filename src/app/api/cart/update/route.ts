...
export async function POST(request: NextRequest) {
  try {
    ...
    const url = `https://shellafood.com/api/v1/customer/cart/update`;

    console.log('[Cart API Route] Updating cart:', {
      url,
      guestId,
      moduleId,
      zoneId,
    ...
    if (!response.ok) {
      ...
      console.error('[Cart API Route] Update Error:', {
    ...
    console.log('[Cart API Route] Update Success');
