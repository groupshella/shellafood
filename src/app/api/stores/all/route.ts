...
/** Proxies Laravel `GET .../stores/get-stores` (moduleId optional; geo via headers). */
export async function GET(req: NextRequest) {
  ...
  const targetUrl = `${API_ROOT}/stores/get-stores?${forward.toString()}`;
  ...
  try {
    ...
    console.error("[api/stores/all]", err);
