		...
		>
			<div className={`text-center max-w-md ${isArabic ? "text-right" : "text-left"}`}>
				...
				<p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
					{isArabic
						? "عذراً، حدث خطأ أثناء تحميل صفحة الأقسام. يرجى المحاولة مرة أخرى."
						: "Sorry, an error occurred while loading the departments page. Please try again."}
				</p>
				...
				<div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
					...
					>
						...
						<span>
							{isArabic ? "العودة إلى الأقسام" : "Back to Categories"}
						</span>
					</Link>
				</div>
			</div>
