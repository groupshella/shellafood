				...
				<div className="mb-6 sm:mb-8">
					<div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 animate-pulse">
						<div className="flex items-center gap-3 flex-row-reverse">
							<div className="h-10 w-10 sm:h-12 sm:w-12 bg-gray-200 dark:bg-gray-700 rounded-xl flex-shrink-0"></div>
							<div className="flex-1 text-right">
								<div className="h-6 sm:h-8 bg-gray-200 dark:bg-gray-700 rounded mb-2 w-3/4 mr-auto"></div>
