	...
	return (
		<div className="min-h-screen bg-gray-100 dark:bg-gray-900" dir="rtl">
			<div className="flex min-h-screen items-center justify-center p-4">
				<div className="flex w-full max-w-6xl flex-col overflow-hidden rounded-xl bg-white dark:bg-gray-800 shadow-lg md:flex-row">
					{/* Sidebar Skeleton */}
						...
						<div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
							...
							<div className="flex flex-col space-y-2 text-right mb-4">
								...
								<div className="relative h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
									<div className="absolute top-0 right-0 h-full bg-gray-300 dark:bg-gray-600 rounded-full w-1/2 animate-pulse"></div>
								</div>
							</div>

							{/* Balance and Limit */}
							<div className="flex flex-col md:flex-row justify-between text-gray-500 dark:text-gray-400 text-sm font-medium mt-4">
								<div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-16 animate-pulse"></div>
								<div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-20 animate-pulse"></div>
							</div>
							<div className="flex flex-col md:flex-row justify-between text-gray-500 dark:text-gray-400 text-sm font-medium">
			...
			<div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 rounded-full px-6 py-3 shadow-lg border border-gray-200 dark:border-gray-700">
				<div className="flex items-center space-x-3 space-x-reverse">
					<div className="w-5 h-5 border-2 border-[#31A342] dark:border-green-500 border-t-transparent rounded-full animate-spin"></div>
					<span className="text-sm text-gray-600 dark:text-gray-300 font-medium">جاري تحميل محفظة قيدها...</span>
				</div>
			</div>
		</div>
	);
