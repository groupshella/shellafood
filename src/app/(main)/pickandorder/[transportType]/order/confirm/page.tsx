...
import OrderConfirmationPage from "@/features/pick-and-order/components/Order/OrderConfirmationPage";
...
export async function generateMetadata({
	...
	return {
		title: isMotorbike
			? `تأكيد الطلب - دراجة نارية${isMultiDirection ? " (متعدد الاتجاهات)" : ""} | شلة خدمات`
			: `تأكيد الطلب - شاحنة${isMultiDirection ? " (متعدد الاتجاهات)" : ""} | شلة خدمات`,
