...
export default function AcceptedDriversError({ error, reset }: ErrorProps) {
	const router = useRouter();

	useEffect(() => {
		console.error("Accepted drivers page error:", error);
	}, [error]);
		...
		<div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 px-4" dir="rtl">
			<div className="text-center max-w-md">
				...
				<p className="text-gray-600 dark:text-gray-400 mb-8">
					عذراً، حدث خطأ أثناء تحميل صفحة السائقين المقبولين. يرجى المحاولة مرة أخرى.
				</p>
