          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
            {Object.entries(store.schedule).map(([day, hours]: [string, any], index) => (
              <motion.div
                ...
                className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 p-3 sm:p-4 rounded-lg sm:rounded-xl ${hours.is_open
              ...
              >
                ...
                <span className={`font-medium ${hours.is_open
...
const InfoItem = memo(({
  ...
  const content = (
    <div className={`p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl border-2 transition-all duration-200 hover:shadow-md ${highlight
      ? "bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800"
      : "bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600"
      } ${className}`}>
      <div className="flex items-start gap-3 sm:gap-4">
        <div className={`p-2 sm:p-2.5 rounded-lg flex-shrink-0 ${highlight
          ? "bg-green-100 dark:bg-green-900/40"
          : "bg-white dark:bg-gray-800"
          }`}>
          <Icon className={`w-4 h-4 sm:w-5 sm:h-5 ${highlight
        ...
        <div className="flex-1 min-w-0">
          ...
          <dd className={`text-sm sm:text-base font-bold break-words ${highlight
            ? "text-green-700 dark:text-green-400"
