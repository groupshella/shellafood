...
interface ModuleStoresListProps {
	moduleId: number;
...
export default function ModuleStoresList({
	moduleId,
	initialStoreList,
	initialPage,
	initialLimit,
	...
	}, [moduleId, initialLimit, currentOffset]);
		...
		<div className="min-w-0 flex-1 space-y-5 sm:space-y-6">
			...
			<div id="stores-list">
				{error ? (
					...
					<>
						<motion.div
							key={`module-stores-p${currentOffset}`}
