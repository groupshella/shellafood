 ...
 * Clean imports: import { ProductCard, EmptyState } from '@/features/categories/components/shared'
 */
...
export { SkeletonCard, SkeletonGrid, SkeletonPage, SkeletonText } from './Skeletons';
