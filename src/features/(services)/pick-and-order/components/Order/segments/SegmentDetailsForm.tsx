...
import type { RouteSegment, ValidationErrors } from "../../../types/pick-and-order.types";
import { PhoneInput } from "@/shared/components";
import MobileMapSection from "../location/MobileMapSection";
import { getGeocoder } from "@/lib/maps/utils";
import { parseAddressComponents } from "@/features/(services)/pick-and-order/lib/utils";
        ...
        {activeTab === "pickup" && (
          ...
          >
            ...
            <div
              ...
              className={`bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 mb-3 sm:mb-4 transition-colors border-2 ${touched[`${segment.id}-pickup-location`] && errors[`${segment.id}-pickup-location`]
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm rounded-lg sm:rounded-xl border-2 ${touched[`${segment.id}-pickup-details`] && errors[`${segment.id}-pickup-details`]
                  ? "border-red-500 dark:border-red-400"
        ...
        {activeTab === "dropoff" && (
          ...
          >
            ...
            <div
              ...
              className={`bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 mb-3 sm:mb-4 transition-colors border-2 ${touched[`${segment.id}-dropoff-location`] && errors[`${segment.id}-dropoff-location`]
                ? "border-red-500 dark:border-red-400"
                : "border-gray-200 dark:border-gray-700"
                }`}
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm rounded-lg sm:rounded-xl border-2 ${touched[`${segment.id}-dropoff-name`] && errors[`${segment.id}-dropoff-name`]
                    ? "border-red-500 dark:border-red-400"
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm rounded-lg sm:rounded-xl border-2 ${touched[`${segment.id}-dropoff-details`] && errors[`${segment.id}-dropoff-details`]
                  ? "border-red-500 dark:border-red-400"
                  : "border-gray-200 dark:border-gray-700 focus:border-orange-500 dark:focus:border-orange-400"
                  } bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none transition-colors`}
              />
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm rounded-lg sm:rounded-xl border-2 ${touched[`${segment.id}-package-description`] && errors[`${segment.id}-package-description`]
                  ? "border-red-500 dark:border-red-400"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm rounded-lg sm:rounded-xl border-2 dir-ltr ${touched[`${segment.id}-package-weight`] && errors[`${segment.id}-package-weight`]
                    ? "border-red-500 dark:border-red-400"
                    : "border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400"
                    } bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none transition-colors`}
                  dir="ltr"
      ...
      <div className="flex items-center justify-between gap-2 sm:gap-3 mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        {activeTab === "package" && onNext && (
          <button
            ...
            className={`px-3 sm:px-4 md:px-6 py-2.5 sm:py-3 font-semibold rounded-lg sm:rounded-xl transition-all touch-manipulation shadow-lg flex items-center justify-center gap-2 min-h-[44px] sm:min-h-[48px] text-xs sm:text-sm md:text-base flex-1 sm:flex-none ${isCompleted
