 ...
 * 
 * @module features/pick-and-order/lib/utils/dataConverter
 */

import type { RouteSegment } from '../../types/pick-and-order.types';
...
export function convertToOldFormat(newData: NewOrderData): OldOrderData {
	...
	return {
		...
		packageWeight: firstSegment?.packageDetails.weight.toString() || "",
