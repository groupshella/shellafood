...
<section className="pb-6 border-b border-gray-200 dark:border-gray-700">
	<div className="flex items-center gap-3 mb-4">
		...
		<h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">
			{isArabic ? "تفاصيل الخدمة والسيارة" : "Service & Car Details"}
		</h2>
	</div>
	...
	<div className="space-y-3 ml-14">
		...
		{bookingData.carInfo && (
			<div className="pt-5 border-t border-gray-200 dark:border-gray-700 space-y-3">
				...
				{/* Plate Number */}
				{bookingData.carInfo.plateNumber && (
					<div className="flex items-start gap-3">
						<span className="text-sm text-gray-600 dark:text-gray-400 flex-shrink-0">
				...
				{/* Mileage */}
				{bookingData.carInfo.mileage && (
					<div className="flex items-center gap-3">
						<span className="text-sm text-gray-600 dark:text-gray-400 flex-shrink-0">
							{isArabic ? "عدد الكيلومترات:" : "Mileage:"}
						</span>
						<span className={`font-medium text-gray-900 dark:text-gray-100 ${isArabic ? "text-right" : "text-left"}`}>
							{bookingData.carInfo.mileage}
						</span>
				...
				{/* Transmission */}
				{bookingData.carInfo.transmission && (
					<div className="flex items-center gap-3">
						<span className="text-sm text-gray-600 dark:text-gray-400 flex-shrink-0">
							{isArabic ? "نوع القير:" : "Transmission:"}
						</span>
						<span className={`font-medium text-gray-900 dark:text-gray-100 ${isArabic ? "text-right" : "text-left"}`}>
							{bookingData.carInfo.transmission}
						</span>
