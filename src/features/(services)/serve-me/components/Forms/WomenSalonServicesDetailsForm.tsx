...
export default function WomenSalonServicesDetailsForm({ service, serviceType }: { service: string; serviceType: string }) {
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
                ...
                <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10 lg:space-y-12">
                    ...
                    <ProblemDescriptionSection
                        ...
                        placeholder={isArabic ? "دعينا نعرف ما تحتاجينه لنقدم لك أفضل تجربة" : "Let us know what you need for the best experience"}
                            ...
                            {addresses.length === 0 ? (
                                ...
                                addresses.map((address) => (
                                    <div
                                        ...
                                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all focus:outline-none focus:ring-2 focus:focus:ring-green-500 dark:focus:ring-green-400 focus:ring-offset-2 ${selectedAddress?.id === address.id
                    ...
                    <NotesSection placeholder={isArabic
                        ? "أي معلومات أخرى تودين مشاركتها معنا..."
