...
import ModulesSliderControls from "./ModulesSLiderControls";
import ModulesSliderGrid from "./ModulesSliderGrid";

export default function ModuleSection({ modules }: { modules: Module[] }) {
