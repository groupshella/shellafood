...
export interface DynamicListSectionProps<T extends Record<string, string> = Record<string, string>> {
	title: string;
 ...
 */
export const DynamicListSection = <T extends Record<string, string> = Record<string, string>>({
	title,
	addButtonText,
	items,
	onAddItem,
