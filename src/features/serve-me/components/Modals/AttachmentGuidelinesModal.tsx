						...
						{isArabic ? (
							<>
								<p className="text-sm sm:text-base mb-3 sm:mb-4">
									لتسريع الخدمة يرجى إرفاق:
								</p>
								<ul className="space-y-2 sm:space-y-3 list-disc list-inside text-sm sm:text-base">
									<li>
										<strong>صورتان رئيسيتان:</strong> واحدة قريبة (تركز على التفاصيل الدقيقة ) والأخرى بعيدة (لتوضيح السياق العام والموقع المحيط).
									</li>
									<li>
										<strong>مقطع فيديو قصير (30 ثانية كحد أقصى):</strong> يصف الخدمة صوتيًا وبصريًا، وهو مفيد جداً في حالة الأعطال التي تتضمن صوتاً أو حركة.
									</li>
								</ul>
							</>
						) : (
