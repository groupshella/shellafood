 ...
 * @param workerId - The worker/driver ID
 * @param orderType - Optional order type (for future type-specific routing)
 * @returns The route path to the worker details page
 */
